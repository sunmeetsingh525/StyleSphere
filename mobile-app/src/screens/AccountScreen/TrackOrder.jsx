  ...
  return (
    <ScrollView>
      <View style={[s.fl1, s.pdlt10, s.mgtp20]}>
        ...
        <Text style={s.f15}>
          Your Order <Text style={s.clBl}>Mens Casual Tshirt</Text> has been
          confirmed by seller,Seller Name.
        </Text>
      ...
      <View style={[s.row, s.spacedBw, s.pdlt10, s.pdrt10, s.bdbt1]}>
        ...
        <Text
          style={[
            s.mgtp20,
            s.mgbt10,
            { color: "#a3a3a3", fontSize: 12, paddingTop: 4 },
          ]}
        >
          Order Id #34b34u334b
        </Text>
      ...
      <View style={[s.row, s.rowflStart, s.pdlt10, s.pdrt10, s.bdbt1]}>
        ...
        <View style={[s.fl3, s.pdbt10]}>
          <Text style={[s.mgtp20, s.mgbt10, s.f18, s.b, { color: "#000000" }]}>
      ...
      <View style={[s.row, s.rowflStart, s.pdlt10, s.pdrt10, s.bdbt1]}>
        ...
        <View style={[s.fl3, s.pdbt10]}>
          <Text
            style={[s.mgtp20, s.mgbt10, s.f18, s.b, { color: "#00000099" }]}
          >
            Order dispatched to delivery
          </Text>
      ...
      <View style={[s.row, s.rowflStart, s.pdlt10, s.pdrt10, s.bdbt1]}>
        ...
        <View style={[s.fl3, s.pdbt10]}>
          <Text
            style={[s.mgtp20, s.mgbt10, s.f18, s.b, { color: "#00000088" }]}
          >
            Arriving Today
          </Text>
          <Text style={[s.f14, { color: "#00000088" }]}>
